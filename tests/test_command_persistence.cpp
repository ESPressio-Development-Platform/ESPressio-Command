...
int main(){
    ...
    auto incomplete=started.TryReserve(Execution(5,1,1));
    assert(incomplete);
    ...
    assert(startedReload.Initialize()==C::CommandRuntimeStatus::PersistenceCorrupt);
    ...
    Eventually([&]{return runtimeStore.Replacements>=3;});
